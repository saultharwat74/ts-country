...
export {
  ...
  TAlbaniaRegions,
  TAnguillaRegion,
  TAntiguaAndBarbudaRegions,
  TArmeniaRegions,
  TAlandRegions,
  TAmericanSamoaRegions,
  TAngolaRegions,
  TAntarcticaRegions,
  TArgentinaRegions,
  TArubaRegions,
  ...
  TBoliviaRegions,
  TBonaireRegions,
  TBosniaAndHerzegovinaRegions,
  TBotswanaRegions,
  TBouvetIslandRegions,
  TBrazilRegions,
  TBruneiRegions,
  TBulgariaRegions,
  TBurkinaFasoRegions,
  TBurundiRegions,
  TSaintBarthelemyRegions,
  TCanadaRegions,
  TCentralAfricanRepublicRegions,
  TCocosKeelingIslandsRegions,
  TDemocraticRepublicOfTheCongoRegions,
  TChileRegions,
  TCookIslandsRegions,
  TIvoryCoastRegions,
  TRepublicOfTheCongoRegions,
  TSwitzerlandRegions,
  TCameroonRegions,
  TCapeVerdeRegions,
  TChinaRegions,
  TChristmasIslandRegions,
  TColombiaRegions,
  TCostaRicaRegions,
  TCubaRegions,
  TCuracaoRegions,
  TCyprusRegions,
  TCzechRepublicRegions,
  TDjiboutiRegions,
  TGermanyRegions,
  TAlgeriaRegions,
  TDenmarkRegions,
  TDominicaRegions,
  TDominicanRepublicRegions,
  TEcuadorRegions,
  TEgyptRegions,
  TEritreaRegions,
  TEstoniaRegions,
  TSpainRegions,
  TWesternSaharaRegions,
} from "./data/regions";
