...
export default {
  ...
  AG: antiguaAndBarbudaRegions,
  AI: anguillaRegions,
  AL: albaniaRegions,
  AM: armeniaRegions,
  AO: angolaRegions,
  AQ: antarcticaRegions,
  AR: argentinaRegions,
  AS: americanSamoaRegions,
  AT: austriaRegions,
  AU: australiaRegions,
  AW: arubaRegions,
  AX: alandRegions,
  AZ: azerbaijanRegions,
  BA: bosniaAndHerzegovinaRegions,
  BB: barbadosRegions,
  BD: bangladeshRegions,
  BE: belgiumRegions,
  BF: burkinaFasoRegions,
  BG: bulgariaRegions,
  BH: bahrainRegions,
  BI: burundiRegions,
  BJ: beninRegions,
  BL: saintBarthelemyRegions,
  BM: bermudaRegions,
  BN: bruneiRegions,
  BO: boliviaRegions,
  BQ: bonaireRegions,
  BR: brazilRegions,
  BS: bahamasRegions,
  BV: bouvetIslandRegions,
  BW: botswanaRegions,
  BY: belarusRegions,
  BZ: belizeRegions,
  CA: canadaRegions,
  CC: cocosKeelingIslandsRegions,
  CD: democraticRepublicOfTheCongoRegions,
  CF: centralAfricanRepublicRegions,
  CG: republicOfTheCongoRegions,
  CH: switzerlandRegions,
  CI: ivoryCoastRegions,
  CK: cookIslandsRegions,
  CL: chileRegions,
  CM: cameroonRegions,
  CN: chinaRegions,
  CO: colombiaRegions,
  ...
  CV: capeVerdeRegions,
  CW: curacaoRegions,
  CX: christmasIslandRegions,
  CY: cyprusRegions,
  CZ: czechRepublicRegions,
  DE: germanyRegions,
  DJ: djiboutiRegions,
  DK: denmarkRegions,
  DM: dominicaRegions,
  DO: dominicanRepublicRegions,
  DZ: algeriaRegions,
  EC: ecuadorRegions,
  EE: estoniaRegions,
  EG: egyptRegions,
